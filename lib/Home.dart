...
class _HomeViewState extends State<HomeView> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  height: media.width * 0.35, // Reduced height
                                          ...
                                          children: [
                                            ...
                                            ShaderMask(
                                              ...
                                              shaderCallback: (bounds) {
                                                return LinearGradient(
                                                        colors:
                                                            [AppColors.secondary, AppColors.primary],                                                        begin: Alignment
                                                            .centerLeft,
                                                        end: Alignment
                                                            .centerRight)
                                                    .createShader(Rect.fromLTRB(
                                    ...
                                    child: Stack(
                                      ...
                                      children: [
                                        ...
                                        SimpleCircularProgressBar(
                                          ...
                                          backStrokeWidth: 10,
                                          progressColors: const [Color.fromARGB(255, 141, 57, 147)],
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: const LinearGradient(colors: [Color.fromARGB(255, 207, 58, 218)]),
                          borderRadius: BorderRadius.circular(15),
                        ),
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton(
                            items: ["Weekly", "Monthly"]
                                ...
                                .toList(),
                            onChanged: (value) {},
                            icon: Icon(Icons.expand_more, color: AppColors.background),
                            hint: Text(
                              "Weekly",
                              textAlign: TextAlign.center,
                              style:
  ...
  List<PieChartSectionData> showingSections() {
    return List.generate(
      2,
      (i) {
        var color0 = AppColors.secondary;
  ...
  LineChartBarData get lineChartBarData1_1 => LineChartBarData(
        isCurved: true,
        gradient: LinearGradient(colors: [
          const Color.fromARGB(183, 43, 180, 105).withOpacity(0.5),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          // Progress indicator
          if (wObj['progress'] != null)
            SizedBox(
              width: 40,
              height: 40,
              child: CircularProgressIndicator(
                value: (wObj['progress'] as double).clamp(0.0, 1.0),
                strokeWidth: 3,
                backgroundColor: Colors.grey.shade300,
                valueColor: AlwaysStoppedAnimation<Color>(
                  Colors.blue, // You can use AppColors.primary here
                ),
              ),
            ),
        ],
